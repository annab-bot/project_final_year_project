...
CLASS_NAMES = ["Alpinia Galanga Rasna", "Amaranthus Viridis Arive Dantu", "Artocarpus Heterophyllus Jackfruit","Azadirachta Indica Neem","Basella Alba Basale","Brassica Juncea Indian Mustard","Carissa Carandas Karanda","Citrus Limon Lemon","Ficus Auriculata Roxburgh fig",
               ...
               "Murraya Koenigii Curry","Nerium Oleander Oleander","Nyctanthes Arbor-tristis Parijata","Ocimum Tenuiflorum Tulsi",
               "Piper Betle Betel","Plectranthus Amboinicus Mexican Mint","Pongamia Pinnata Indian Beech","Psidium Guajava Guava","Punica Granatum Pomegranate",
...
async def read_item(request: Request):
    return templates.TemplateResponse("Medicinal_Uses.html",{"request":request})
